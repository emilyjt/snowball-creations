    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_network', models.CharField(choices=[('Instagram', 'Instagram'), ('Facebook', 'Facebook'), ('Linkedin', 'Linkedin'), ('Youtube', 'Youtube'), ('Tiktok', 'Tiktok'), ('Twitter', 'Twitter'), ('Other', 'Other')], default='Instagram', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_contact', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='dashboard.User')),
            ],
        ),
    ]
